...
class TestRegimeDetector:
    def test_trend_high_vol(self):
        rd = RegimeDetector()
        features = Features(
            timestamp=datetime.now(timezone.utc), pair="BTCUSDT", timeframe="1h",
...
class TestStrategyEngine:
    def test_signal_structure(self):
        signal = Signal(
            ...
            regime="trend_high_vol", factors=[], timestamp=datetime.now(timezone.utc),
        )
...
class TestRiskEngine:
    ...
    def test_max_positions_limit(self):
        ...
        signal = Signal(
            ...
            stop_loss=64500, tp1=66000, tp2=67000,
            strategy=StrategyType.SWEEP, confidence=0.8,
            regime="trend", factors=[], timestamp=datetime.now(timezone.utc),
        )
        portfolio = re.get_portfolio_state()
...
class TestAnalytics:
    ...
    def test_basic_metrics(self):
        ...
        srv.add_trade({
            ...
            "timestamp": datetime.now(timezone.utc), "strategy": "sweep", "pair": "BTCUSDT",
        })
        srv.add_trade({
