...
class ConfigRegistry:
    ...
    def _parse_config(self, raw: dict) -> SystemConfig:
        ...
        config.created_at = raw.get("created_at", datetime.now(timezone.utc))
        ...
        if "risk" in raw:
            ...
            config.risk = RiskConfig(
                ...
                recovery_threshold=recovery.get("threshold", 8.0),
                recovery_exit_threshold=recovery.get("exit_threshold", 5.0),
                recovery_min_wins=recovery.get("min_wins", 3),
            )
        ...
        if "learning" in raw:
            ...
            config.learning = LearningConfig(
                ...
                stability_threshold=l.get("stability_threshold", 0.30),
            )
